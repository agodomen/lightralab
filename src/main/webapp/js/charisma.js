...
charismaTour = function charismaTour() {
    //tour
...
charismaGallery = function charismaGallery() {
...
openNotify = function openNotify(type, content, url) {
    if (type == 'notify') {
        $('#myModal-info-notify-body').html(content);
        $('#myModal-info-notify-footer-ok').attr("onclick",
            "loadContentHtml('" + url + "')");
        $('#myModal-info-notify').modal('show');
    } else if (type == "setting") {
        loadHtml(content, "#myModal-info-setting-body");
        $('#myModal-info-setting').modal('show');
    }
}


loadContentHtml = function (urlLoad) {
    urlLoad = systemGetRootPath() + urlLoad;
    $("#content").load(urlLoad, {}, function () {
    });
}
