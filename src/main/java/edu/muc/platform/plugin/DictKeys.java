...
public abstract class DictKeys {
     ...
     *
     */
    public static final SimpleDateFormat simpleDateFormat = new SimpleDateFormat("MMddSSssmmHHyyyy");

    public static final SimpleDateFormat monthDateFormat = new SimpleDateFormat("yyyyMM");
